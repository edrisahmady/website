...
> = {
  ...
  interaction: Section.category(PropsCategory.Interaction).children({
    showCloseButton: Prop.boolean().propertiesPanel({
...
// Register Component
registerComponent(Dialog, propertiesDefinition).editorConfig(editorConfig);
registerComponent(DialogTrigger, childrenPropertiesDefinition);
registerComponent(DialogClose);
registerComponent(DialogContent, childrenPropertiesDefinition);
registerComponent(DialogDescription, childrenPropertiesDefinition);
registerComponent(DialogFooter, childrenPropertiesDefinition);
registerComponent(DialogHeader, childrenPropertiesDefinition);
registerComponent(DialogTitle, childrenPropertiesDefinition);
