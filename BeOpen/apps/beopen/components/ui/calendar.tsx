...
type BaseCalendarProps = React.ComponentPropsWithoutRef<typeof DayPicker> & {
...
// Calendar Component with Extended Props for Registration
type ComponentProps = ComponentPropsWithoutRef<typeof Calendar> & {
  selected?: string;
...
const propertiesDefinition: PropertiesPanelDefinition<ComponentProps> = {
  general: Section.category(PropsCategory.Content).children({
    selected: Prop.string().propertiesPanel({
      label: "Selected",
      controlType: "INPUT_TEXT",
      description: "The controlled value of the calendar",
      isRemovable: true,
  ...
  interaction: Section.category(PropsCategory.Interaction).children({
    showOutsideDays: Prop.boolean().propertiesPanel({
  ...
  events: Section.category(PropsCategory.EventHandlers).children({
    onSelect: Prop.eventHandler().propertiesPanel({
      label: "onSelect",
      description: "Event handler called when the date is selected",
    }),
  }),
};
...
// Register Component
registerComponent(Calendar, propertiesDefinition)
